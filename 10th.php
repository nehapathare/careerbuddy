                ...
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
                            <h1 data-animation="fadeInLeft" data-delay="1s">What after 10th? </h1>
                            <p data-animation="fadeInUp" data-delay="1.3s">Studying what you love will help you Score well in your exams.</p>
                            <ul>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="category-text pt-40">
                            <h2>Choose the Best Stream for you </h2>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <div class="about-cont">
                        <a href="aboutus.php" class="main-btn mt-55">Learn More</a>
                    </div>
                </div> <!-- about cont -->
