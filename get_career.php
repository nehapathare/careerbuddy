...
<body>
				...
				<div class="row">
					<div class="col-lg-12">
						<nav class="navbar navbar-expand-lg">
							<a class="navbar-brand" href="index-4.html"> <img
							...
							<div class="right-icon text-right">
								<ul>
									<li><a href="javascript:void(0)" id="search"><i
	...
	<div class="container register">
		<div class="row">
			<div class="col-md-3 register-left">
				...
				<p style="color:white">You are 30 seconds away from deciding your Career!</p>
				<br />
			</div>
			<div class="col-md-9 register-right">
				<ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
					<li class="nav-item"><a class="nav-link active" id="home-tab"
						...
						aria-selected="true">SIGN-UP</a></li>
					<li class="nav-item"><a class="nav-link" id="profile-tab"
						data-toggle="tab" href="#profile" role="tab"
						aria-controls="profile" aria-selected="false">LOG-IN</a></li>
				</ul>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<select class="form-control">
										<option class="hidden" selected disabled>Please select your
								...
								<input type="button" onclick="window.location.href = 'index.php';" class="btnRegister" value="Register" />
							</div>
						</div>
					</div>
					<div class="tab-pane fade show" id="profile" role="tabpanel"
						...
						<div class="row register-form">
							...
							<div class="col-md-6">
								...
								<input type="submit"  onclick="window.location.href = 'index.php';" class="btnRegister" value="Register" />
							</div>
						</div>
					</div>
				</div>
	...
	<!--====== Map js ======-->
	<script
		src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDC3Ip9iVC0nIxC6V14CKLQ1HZNF_65qEQ"></script>
